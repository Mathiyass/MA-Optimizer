...
Open **PowerShell as Administrator** and paste the following to automatically download and install the latest release:
...
We believe in **"No Snake Oil"** optimization. Here's our promise:
