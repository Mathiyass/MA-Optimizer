...
1. Navigate to the [Releases](https://github.com/Mathiyass/MA-Optimizer/releases/tag/v12.0.0) page.
2. Download `v12.0.MA-Optimizer.Installer.Setup.exe` (Installer) or `v12.0.MA-Optimizer.Portable.exe` (Portable).
