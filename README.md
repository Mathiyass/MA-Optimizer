...
1. Navigate to the [Releases](https://github.com/Mathiyass/MA-Optimizer/releases/tag/v11.4.0) page.
2. Download `v11.4.MA-Optimizer.Installer.Setup.exe` (Installer) or `v11.4.MA-Optimizer.Portable.exe` (Portable).
