...
export function About() {
    ...
    return (
        ...
        >
            ...
            <motion.div variants={item} className="relative overflow-hidden rounded-[2.5rem] p-12 transition-all duration-700 border bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-white/5 text-center">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <motion.div
                        className="w-28 h-28 mx-auto mb-6 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(0,255,222,0.3)] bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 border-[var(--accent-cyan)]/30 relative"
                        animate={{
                            boxShadow: [
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <span className="px-3 py-1 bg-[var(--accent-cyan)]/10 border-[var(--accent-cyan)]/30 text-[var(--accent-cyan)] rounded-2xl text-xs font-black uppercase tracking-widest">Version 7.1.0</span>
                        <span className="px-3 py-1 bg-[#00FFDE]/10 border-[#00FFDE]/30 text-[#00FFDE] rounded-2xl text-xs font-black uppercase tracking-widest">Stable</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Credits */}
                <motion.div variants={item} className="card-premium border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl flex flex-col justify-between h-full hover:border-white/20 transition-all duration-300">
                    <div>
                        ...
                        <div className="flex items-center gap-5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 p-5 rounded-2xl border-white/5">
                            <motion.img
                                src={meImg}
                                alt="Mathisha Angirasa"
                                className="w-20 h-20 rounded-2xl object-cover shadow-[0_0_15px_rgba(0,255,222,0.3)] border-[var(--accent-violet)]/50"
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                        <a href="https://github.com/Mathiyass/MA-Optimizer" target="_blank" rel="noopener noreferrer"
                            className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 border-white/10 rounded-2xl text-xs font-black uppercase tracking-widest text-white hover:bg-[rgba(255,255,255,0.05)] hover:border-white/30 transition-all group shadow-inner">
                ...
                {/* Tech Stack */}
                <motion.div variants={item} className="card-premium border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl hover:border-white/20 transition-all duration-300">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {['Electron 30', 'React 18', 'TypeScript 5', 'Vite 5', 'Tailwind CSS 3', 'Zustand', 'Framer Motion', 'Recharts', 'Winston Logger', 'electron-builder', 'Lucide Icons'].map(t => (
                            <span key={t} className="px-4 py-2 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 border-white/10 rounded-2xl text-[var(--text-muted)] text-[11px] font-black uppercase tracking-widest hover:border-[var(--accent-cyan)]/40 hover:text-[var(--accent-cyan)] hover:bg-[var(--accent-cyan)]/10 transition-all cursor-default shadow-inner">{t}</span>
                        ))}
                    </div>
                </motion.div>
            </div>
                ...
                <motion.div variants={item} className="card-premium border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl hover:border-white/20 transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3 bg-[rgba(255,255,255,0.01)] backdrop-blur-3xl border-white/5 p-3 rounded-2xl border-white/5">
                ...
                <div className="space-y-8">
                    ...
                    <motion.div variants={item} className="card-premium border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl hover:border-white/20 transition-all duration-300">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3"><div className="mt-0.5 w-4 h-4 rounded-full bg-[#00FFDE]/20 flex items-center justify-center shrink-0 border-[#00FFDE]/50"><div className="w-1.5 h-1.5 rounded-full bg-[#00FFDE]" /></div><span className="text-[var(--text-muted)] text-[13px] font-bold">Automatic registry backup before every change</span></li>
                            <li className="flex items-start gap-3"><div className="mt-0.5 w-4 h-4 rounded-full bg-[#00FFDE]/20 flex items-center justify-center shrink-0 border-[#00FFDE]/50"><div className="w-1.5 h-1.5 rounded-full bg-[#00FFDE]" /></div><span className="text-[var(--text-muted)] text-[13px] font-bold">One-click undo for all modifications (Ctrl+Z)</span></li>
                            <li className="flex items-start gap-3"><div className="mt-0.5 w-4 h-4 rounded-full bg-[#00FFDE]/20 flex items-center justify-center shrink-0 border-[#00FFDE]/50"><div className="w-1.5 h-1.5 rounded-full bg-[#00FFDE]" /></div><span className="text-[var(--text-muted)] text-[13px] font-bold">Confirmation dialog for aggressive tweaks</span></li>
                            <li className="flex items-start gap-3"><div className="mt-0.5 w-4 h-4 rounded-full bg-[#00FFDE]/20 flex items-center justify-center shrink-0 border-[#00FFDE]/50"><div className="w-1.5 h-1.5 rounded-full bg-[#00FFDE]" /></div><span className="text-[var(--text-muted)] text-[13px] font-bold">Color-coded risk levels profiling</span></li>
                        </ul>
                    </motion.div>
                    ...
                    <motion.div variants={item} className="card-premium border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl hover:border-white/20 transition-all duration-300">
                        ...
                        <div className="space-y-6">
                            <div className="relative pl-6 border-l-2 border-[var(--accent-cyan)]/50">
                                ...
                                <div className="text-white text-[15px] font-black tracking-wide flex items-center gap-3">v7.1.0 <span className="bg-[var(--accent-cyan)]/20 text-[var(--accent-cyan)] text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-2xl border-[var(--accent-cyan)]/30">Latest</span></div>
