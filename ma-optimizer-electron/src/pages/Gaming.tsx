        ...
        <div className="space-y-8 max-w-[90rem] mx-auto w-full pb-10">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                            {gpuInfo && (
                                <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 border-white/10 backdrop-blur-md">
            ...
            {gameBoostOn && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-scale-in">
                    <div className="rounded-[2.5rem] p-8 border-white/5 bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl">
                        ...
                        <div className="h-2 w-full bg-[rgba(255,255,255,0.03)] backdrop-blur-3xl border-white/5 rounded-full overflow-hidden">
